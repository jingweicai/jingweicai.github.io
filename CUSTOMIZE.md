...
This Jekyll site uses a `news` collection. Items from the collection are automatically displayed on the home page.

You can create additional collections by editing [\_config.yml](_config.yml), creating a corresponding folder, and adding a landing page for the collection.
